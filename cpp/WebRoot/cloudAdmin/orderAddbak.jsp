...
<body>
									...
									<div class="box-body">
										 <div class="box border blue">	
										 	    ...
										 	    <tr>
										 	     ...
										 	     <td>  <label>&nbsp;&nbsp;&nbsp;&nbsp;</label> </td>
										 	     <td>  <label>应收应付:</label></td>
										 	     <td>  										 	    
													<select name="mainOrder.use_ysyf"   class="form-control">
			                                            <c:forEach items="${ysyfList}" var="ysyf">
			                                              <option >${ysyf}</option>  
			                                            </c:forEach>  
													</select>
                                                 </td>
                                                 <!--  
										 	     ...
										 	     <td>  <input type="text"   class="form-control" name="mainOrder.ysyfje"  readonly="readonly"  value="${mainOrder.ysyfje}" /></td>	
										 	     -->
										 	    <tr><td><label>&nbsp;&nbsp;&nbsp;&nbsp;</label></td></tr>
										 	    <tr>	
										 	    <td><label>&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
		...
		function addTr(spbh,spmch,shpgg,dw,jixing,shpchd,shj,jlgg){
			if(validataTable(spbh)){
				var newRow = "<tr ><td></td><td>"
	               ...
	               + jlgg + "</td><td>"  
	            //   + shj + "</td><td>"  
	               + "<input type =\"text\" id =\"table_sl"+spbh+"\" name=\"table_s1_zb\" />" + "</td><td>"   
	               + "<input type =\"text\" id =\"table_sl2"+spbh+"\" name=\"table_s1_ls\" />" + "</td><td>"  

	            //   + "<input type =\"text\" id =\"table_je"+spbh+"\"   name=\"table_je\"readonly=\"readonly\"  />"  + "</td><td>"   
				...
				//	var je = (Number(shj)*Number($("#table_sl"+spbh).val())).toFixed(4);
				//	$("#table_je"+spbh).val(je);
				//	hj();
				//}); 
	...
	//	function hj(){
	//		 var zje = 0.0000;
	//		 $("#detailTable tr td:nth-child(12)").each(function () {
	//			 zje +=   Number($(this).find("input").val());
	//		});
	//		 $("#hjTable").text(Number(zje).toFixed(4));
	//		 $("input[name='mainOrder.ysyfje']").val(Number(zje).toFixed(4));  
	//	}
