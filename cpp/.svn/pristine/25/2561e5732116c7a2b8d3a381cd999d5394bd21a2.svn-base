...
import com.cpp.zhuangchedan.ZhuangchedanController;
...
public class MyConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		...
		me.add("/wl",ZhuangchedanController.class,"/cloudAdmin/");	
	...
	public void configPlugin(Plugins me) {
		...
		arp.addMapping("pf_djhz","djbh", Order.class);	// 映射pf_djhz 表到 Order模型
		arp.addMapping("pf_djmx","djbh,dj_sn", OrderDetail.class);	
		arp.addMapping("userInfo", User.class);	// 映射pf_djhz 表到 Order模型
	}
